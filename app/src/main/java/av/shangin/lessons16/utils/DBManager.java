...
public class DBManager {
    ...
    public long addNote(NoteBean nb){
    ...
    public long updateNote(NoteBean nb){
    ...
    private ContentValues getContentValuesForUpdate(NoteBean nb) {
    ...
    private ContentValues getContentValues(NoteBean nb) {
        ContentValues values = new ContentValues();
    ...
    private ArrayList<NoteBean> parseCursor(Cursor cursor, long rowId) {
        ...
        if(rowId<0) {
            ...
            while (cursor.moveToNext()) {
                ...
                NoteBean nb = new NoteBean(h,"",itemId,d);
                notes.add(nb);
                ...
                //notes.add(new NoteBean(h,"",itemId,ld);
            ...
            if(cursor.moveToFirst()) {
                ...
                NoteBean nb = new NoteBean(h,b,itemId,d);
                notes.add(nb);
                ...
                //String  b=cursor.getString(cursor.getColumnIndex(NoteContract.NoteEntry.COLUMN_NAME_BODY));
                //String d=cursor.getString(cursor.getColumnIndex(NoteContract.NoteEntry.COLUMN_LASTUPDATE));
                //notes.add(new NoteBean(h,b,itemId,d));
    ...
    public ArrayList<NoteBean> getNote(long rowId) {
        ArrayList<NoteBean> notes = new ArrayList<NoteBean>();
        SQLiteDatabase db = null;
